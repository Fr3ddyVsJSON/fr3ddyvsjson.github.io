...
![Gitlab Homepage]({{"/post_images/post1/20210504235511.png" | absolute_url}})

After completing the **Laboratory** Box, I knew you could checkout the `/help` page to get a version number of GitLab.

![Gitlab before login]({{"/post_images/post1/20210505194213.png" | absolute_url}})
...
![Gitlab after login]({{"/post_images/post1/20210505000358.png" | absolute_url}})
